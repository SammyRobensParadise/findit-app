...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<th scope='row'><button class='btn btn-info'>Edit</button></th>"."<td>". $row["ItemName"] . "</td><td>". $row["Comment"]."</td><td>". $row["ItemKeyWord"] . "</td><td>". $row["KeywordID"]."</td>";
        echo "</tr>";

    }
} else {
    echo "<tr>";
    echo "<th scope='row' style='color:red'>0 results found. Try chaning your Key Words</th>";
    echo "</tr>";
}
CloseCon($conn);
?>
